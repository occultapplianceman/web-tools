...
echo   1. Add your specific FFmpeg installation to system PATH
echo   2. Ensure yt2mp3.exe can find and use it
echo.
...
set "FFMPEG_BIN_PATH=%USERPROFILE%\Downloads\ffmpeg-2025-11-17-git-e94439e49b-essentials_build\bin"
...
if not exist "%FFMPEG_BIN_PATH%\ffmpeg.exe" (
    ...
    echo.
    echo Please check if the folder exists or if you moved it.
    echo If you moved it, update this script with the new path.
    echo.
    pause
    exit /b 1
)
